...
def test_agent_fix():
    ...
    class MockAIProcessor:
        def __init__(self):
            ...
            self._last_detailed_usage = {"total_tokens": 10, "input_tokens": 5, "output_tokens": 5, "cached_tokens": 0}
        ...
        def process_question(
            self, question, conversation_history, codebase_content, model, max_tokens, temperature, update_callback=None
        ):
    ...
    result = session.ask_question(question="What is this code about?", agent_prompt=agent_prompt)
