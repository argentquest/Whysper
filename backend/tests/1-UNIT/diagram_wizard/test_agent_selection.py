...
def test_agent_prompt_on_first_message():
    ...
    with patch("common.ai.create_ai_processor") as mock_create:
        ...
        def capture_process_question(
            question, conversation_history, codebase_content, model, max_tokens, temperature, update_callback=None
        ):
        ...
        with patch.object(session, "add_file") as mock_add_file:
            ...
            session.ask_question(question="What is this code about?", agent_prompt=test_agent_prompt)
...
def test_agent_prompt_on_subsequent_message():
    ...
    with patch("common.ai.create_ai_processor") as mock_create:
        ...
        with patch.object(session, "add_file"):
            ...
            session.ask_question(question="What about this code?", agent_prompt=test_agent_prompt)
        ...
        system_content = system_messages[0].get("content", "")
        assert (
            "JavaScript expert" in system_content
        ), f"Agent prompt NOT found in updated system message: {system_content[:200]}..."
