...
def process_test(test_case: Dict[str, Any], output_dir: str) -> Dict[str, Any]:
    ...
    history_file = f"tests/Diagrams/history/test_{result['test_id']:03d}_id_{result['test_id']}"
...
def main():
    ...
    print("D2 CLI Validator - Processing all 25 tests")
    print("=" * 60)
    ...
    output_dir = "backend/test_results_25/errors"
    ...
    for test_case in test_cases:
        ...
        result = process_test(test_case, output_dir)
