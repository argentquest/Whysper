...
def check_config_loading():
    ...
    try:
        ...
        print("✅ Root config loaded successfully")
                ...
                try:
                    ...
                    if "custom" in config_data:
                        ...
                        if "executable_path" in custom:
                            ...
                            if path is None:
                                print("      ⚠️  executable_path is null - may cause issues")
                            elif isinstance(path, str) and not path.strip():
                                print("      ⚠️  executable_path is empty string")
                            else:
                                print(f"      ✅ executable_path: {path}")
                        else:
                            print("      ⚠️  No executable_path in custom settings")
...
def check_environment():
    ...
    env_vars = ["PROVIDERS", "DEBUG", "PYTHONPATH"]
