...
class ExportService:
    ...
    def __init__(self):
        ...
        self.templates_dir = os.path.join(os.path.dirname(__file__), "../../templates/export")
    ...
    def get_format_options(self, format: str) -> Dict[str, Any]:
        ...
        Args:
            format: The format to retrieve options for (e.g., 'pd', 'html').
        ...
        options = {
            ...
            "docx": {"font_size": [10, 11, 12], "template": ["default", "professional"]},
        }
