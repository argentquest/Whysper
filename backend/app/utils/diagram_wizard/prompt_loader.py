...
def load_prompts() -> Dict[str, str]:
    ...
    if clarify_path.exists():
        _prompt_cache["clarify_mermaid"] = _extract_section(clarify_path, "Mermaid Prompts")
        _prompt_cache["clarify_d2"] = _extract_section(clarify_path, "D2 Prompts")
        _prompt_cache["clarify_plantuml"] = _extract_section(clarify_path, "PlantUML Prompts")
