...
<svg width="400" height="300" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Title -->
  <text x="200" y="25" class="title">WhysperCode Flowchart</text>
  ...
  <text x="200" y="280" style="font-size: 10px; fill: #666; text-anchor: middle;">Generated by WhysperCode Web2</text>
</svg>'''
