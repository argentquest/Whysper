...
class OpenRouterProvider(BaseAIProvider):
    ...
    def _get_provider_config(self) -> AIProviderConfig:
        ...
        config = AIProviderConfig(name="openrouter", api_url=settings.openrouter_api_url, supports_tokens=True)

        # OpenRouter-specific headers
        config.headers.update({"HTTP-Referer": settings.openrouter_http_referer, "X-Title": settings.openrouter_title})
