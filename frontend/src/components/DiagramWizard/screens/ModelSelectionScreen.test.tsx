...
import { type ModelId,ModelSelectionScreen } from './ModelSelectionScreen'
...
describe('ModelSelectionScreen', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display all model descriptions', () => {
      ...
      expect(screen.getByText(/Transparent thinking with structured reasoning/)).toBeInTheDocument()
      expect(screen.getByText(/Efficient output with pragmatic approach/)).toBeInTheDocument()
    })
  ...
  describe('Selection Interaction', () => {
    it('should call onSelect with gpt5 when Deep Context is clicked', () => {
      render(<ModelSelectionScreen onSelect={mockOnSelect} />)
      const deepContextCard = screen.getByText('Deep Context').closest('div[class*="card"]')
    ...
    it('should call onSelect with gemini when Efficient is clicked', () => {
      render(<ModelSelectionScreen onSelect={mockOnSelect} />)
      const efficientCard = screen.getByText('Efficient').closest('div[class*="card"]')
  ...
  describe('Loading State', () => {
    ...
    it('should have reduced opacity when loading', () => {
      const { container } = render(<ModelSelectionScreen onSelect={mockOnSelect} loading={true} />)
  ...
  describe('Styling and Layout', () => {
    ...
    it('should center content vertically and horizontally', () => {
      const { container } = render(<ModelSelectionScreen onSelect={mockOnSelect} />)
      const layout = container.querySelector('div[style*="justifyContent: center"]')
      expect(layout).toBeInTheDocument()
    })
  })
