...
describe('SystemDescriptionScreen', () => {
  ...
  describe('Model Management', () => {
    ...
    it('should handle all model types', () => {
      ...
      models.forEach((model) => {
        const { unmount } = render(<SystemDescriptionScreen {...mockProps} selectedModel={model} />)
  ...
  describe('Chat Panel Conditional Rendering', () => {
    ...
    it('should show ChatPanel when in analysis phase', () => {
      render(
        <SystemDescriptionScreen {...mockProps} isInAnalysisPhase={true} sessionId="test-session" />
      )
  ...
  describe('Clarification Handling', () => {
    ...
    it('should display clarifications count when provided', () => {
      const clarifications = [{ question: 'What type of system?', answer: 'E-commerce' }]
      render(
  ...
  describe('SSE Connection Status', () => {
    it('should show Connected status when connected', () => {
      render(
        <SystemDescriptionScreen {...mockProps} sessionId="test-session-123" sseConnected={true} />
      )
    ...
    it('should show Disconnected status when not connected', () => {
      render(
        <SystemDescriptionScreen {...mockProps} sessionId="test-session-123" sseConnected={false} />
      )
