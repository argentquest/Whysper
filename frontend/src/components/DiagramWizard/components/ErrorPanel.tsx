  ...
  if (!hasErrors && !hasWarnings && !hasSuggestions) {
    return (
      <div style={{ padding: '16px', textAlign: 'center' }}>
        <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="No validation errors" />
      </div>
    )
  }
          ...
          renderItem={(error) => (
            ...
            >
              ...
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                ...
                <div style={{ fontSize: '13px', color: '#262626' }}>{error.message}</div>
              </Space>
            </List.Item>
          )}
        />
          ...
          renderItem={(warning) => (
            ...
            >
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                ...
                <div style={{ fontSize: '13px', color: '#262626' }}>{warning.message}</div>
              </Space>
            </List.Item>
          )}
        />
